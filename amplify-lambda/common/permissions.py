...
permissions_by_state_type = {
    "/state/share": {"append": can_share, "read": can_read_share},
    "/state/share/load": {"load": can_read_share},
    "/datasource/metadata/set": {"set": can_upload},
    "/files/upload": {"upload": can_upload},
    "/files/set_tags": {"set_tags": can_upload},
    "/files/tags/create": {"create": can_upload},
    "/files/tags/delete": {"delete": can_upload},
    "/files/tags/list": {"list": can_upload},
    "/files/query": {"query": can_upload},
    "/files/download": {"download": can_upload},
    "/chat/convert": {"convert": can_publish_item},
    "/state/accounts/charge": {"create_charge": can_publish_item},
    "/state/accounts/get": {"get": can_read},
    "/state/accounts/save": {"save": can_publish_item},
    ...
    "/chat": {"chat": can_chat},
    "/state/settings/save": {"save": can_upload},
